...
static struct queue_node *initialize_queue_node(void *data) {
...
static int isEmpty(struct queue *self) { return self->head == (void *)0; }

static void enqueue(struct queue *self, void *data) {
...
static void dequeue(struct queue *self) {
